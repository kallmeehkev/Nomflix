...
Genre.destroy_all
Genre.create!(name: "Anime-Food") #id is 1
Genre.create!(name: "Big-Baller")  #id is 2
Genre.create!(name: "Competition") #id is 3
Genre.create!(name: "Dog") #id is 4
Genre.create!(name: "Exotic") #id is 5
Genre.create!(name: "Gluttony") #id is 6
Genre.create!(name: "Meat") #id is 7
Genre.create!(name: "Specialty") #id is 8
Genre.create!(name: "Spicy") #id is 9
Genre.create!(name: "Sweet") #id is 10
Genre.create!(name: "Travel") #id is 11
Genre.create!(name: "Tutorial") #id is 12
...
#Anime-Food
MediaGenre.create!(genre_id: 1, media_id: 47)
MediaGenre.create!(genre_id: 1, media_id: 48)
MediaGenre.create!(genre_id: 1, media_id: 49)
MediaGenre.create!(genre_id: 1, media_id: 50)
MediaGenre.create!(genre_id: 1, media_id: 51)
MediaGenre.create!(genre_id: 1, media_id: 52)
MediaGenre.create!(genre_id: 1, media_id: 53)
MediaGenre.create!(genre_id: 1, media_id: 54)
MediaGenre.create!(genre_id: 1, media_id: 55)
MediaGenre.create!(genre_id: 1, media_id: 56)

#Big-Baller
MediaGenre.create!(genre_id: 2, media_id: 2)
MediaGenre.create!(genre_id: 2, media_id: 5)
MediaGenre.create!(genre_id: 2, media_id: 14)
MediaGenre.create!(genre_id: 2, media_id: 15)
MediaGenre.create!(genre_id: 2, media_id: 29)
MediaGenre.create!(genre_id: 2, media_id: 31)
MediaGenre.create!(genre_id: 2, media_id: 41)
MediaGenre.create!(genre_id: 2, media_id: 42)
MediaGenre.create!(genre_id: 2, media_id: 43)
MediaGenre.create!(genre_id: 2, media_id: 44)

#Competition
MediaGenre.create!(genre_id: 3, media_id: 9)
MediaGenre.create!(genre_id: 3, media_id: 10)
MediaGenre.create!(genre_id: 3, media_id: 11)
MediaGenre.create!(genre_id: 3, media_id: 12)
MediaGenre.create!(genre_id: 3, media_id: 13)
MediaGenre.create!(genre_id: 3, media_id: 35)
MediaGenre.create!(genre_id: 3, media_id: 36)
MediaGenre.create!(genre_id: 3, media_id: 37)
MediaGenre.create!(genre_id: 3, media_id: 39)
MediaGenre.create!(genre_id: 3, media_id: 45)

#Dog
MediaGenre.create!(genre_id: 4, media_id: 16)
MediaGenre.create!(genre_id: 4, media_id: 17)
MediaGenre.create!(genre_id: 4, media_id: 18)
MediaGenre.create!(genre_id: 4, media_id: 19)
MediaGenre.create!(genre_id: 4, media_id: 20)
MediaGenre.create!(genre_id: 4, media_id: 24)
MediaGenre.create!(genre_id: 4, media_id: 25)
MediaGenre.create!(genre_id: 4, media_id: 26)
MediaGenre.create!(genre_id: 4, media_id: 27)
MediaGenre.create!(genre_id: 4, media_id: 28)

#Exotic
MediaGenre.create!(genre_id: 5, media_id: 14)
MediaGenre.create!(genre_id: 5, media_id: 15)
MediaGenre.create!(genre_id: 5, media_id: 19)
MediaGenre.create!(genre_id: 5, media_id: 20)
MediaGenre.create!(genre_id: 5, media_id: 25)
MediaGenre.create!(genre_id: 5, media_id: 27)
MediaGenre.create!(genre_id: 5, media_id: 30)
MediaGenre.create!(genre_id: 5, media_id: 33)
MediaGenre.create!(genre_id: 5, media_id: 34)
MediaGenre.create!(genre_id: 5, media_id: 38)

#Gluttony
MediaGenre.create!(genre_id: 6, media_id: 5)
MediaGenre.create!(genre_id: 6, media_id: 8)
MediaGenre.create!(genre_id: 6, media_id: 9)
MediaGenre.create!(genre_id: 6, media_id: 10)
MediaGenre.create!(genre_id: 6, media_id: 29)
MediaGenre.create!(genre_id: 6, media_id: 30)
MediaGenre.create!(genre_id: 6, media_id: 35)
MediaGenre.create!(genre_id: 6, media_id: 36)
MediaGenre.create!(genre_id: 6, media_id: 37)
MediaGenre.create!(genre_id: 6, media_id: 39)

#Meat
MediaGenre.create!(genre_id: 7, media_id: 1)
MediaGenre.create!(genre_id: 7, media_id: 2)
MediaGenre.create!(genre_id: 7, media_id: 3)
MediaGenre.create!(genre_id: 7, media_id: 4)
MediaGenre.create!(genre_id: 7, media_id: 5)
MediaGenre.create!(genre_id: 7, media_id: 8)
MediaGenre.create!(genre_id: 7, media_id: 11)
MediaGenre.create!(genre_id: 7, media_id: 12)
MediaGenre.create!(genre_id: 7, media_id: 13)
MediaGenre.create!(genre_id: 7, media_id: 16)
MediaGenre.create!(genre_id: 7, media_id: 17)
MediaGenre.create!(genre_id: 7, media_id: 18)
MediaGenre.create!(genre_id: 7, media_id: 19)
MediaGenre.create!(genre_id: 7, media_id: 21)
MediaGenre.create!(genre_id: 7, media_id: 25)
MediaGenre.create!(genre_id: 7, media_id: 28)
MediaGenre.create!(genre_id: 7, media_id: 29)
MediaGenre.create!(genre_id: 7, media_id: 30)
MediaGenre.create!(genre_id: 7, media_id: 33)
MediaGenre.create!(genre_id: 7, media_id: 35)

#Specialty
MediaGenre.create!(genre_id: 8, media_id: 1)
MediaGenre.create!(genre_id: 8, media_id: 2)
MediaGenre.create!(genre_id: 8, media_id: 4)
MediaGenre.create!(genre_id: 8, media_id: 6)
MediaGenre.create!(genre_id: 8, media_id: 7)
MediaGenre.create!(genre_id: 8, media_id: 31)
MediaGenre.create!(genre_id: 8, media_id: 40)
MediaGenre.create!(genre_id: 8, media_id: 42)
MediaGenre.create!(genre_id: 8, media_id: 43)
MediaGenre.create!(genre_id: 8, media_id: 44)

#Spicy
MediaGenre.create!(genre_id: 9, media_id: 8)
MediaGenre.create!(genre_id: 9, media_id: 9)
MediaGenre.create!(genre_id: 9, media_id: 11)
MediaGenre.create!(genre_id: 9, media_id: 12)
MediaGenre.create!(genre_id: 9, media_id: 13)
MediaGenre.create!(genre_id: 9, media_id: 32)
MediaGenre.create!(genre_id: 9, media_id: 34)
MediaGenre.create!(genre_id: 9, media_id: 38)
MediaGenre.create!(genre_id: 9, media_id: 40)
MediaGenre.create!(genre_id: 9, media_id: 46)

#Sweet
MediaGenre.create!(genre_id: 10, media_id: 10)
MediaGenre.create!(genre_id: 10, media_id: 20)
MediaGenre.create!(genre_id: 10, media_id: 22)
MediaGenre.create!(genre_id: 10, media_id: 23)
MediaGenre.create!(genre_id: 10, media_id: 24)
MediaGenre.create!(genre_id: 10, media_id: 26)
MediaGenre.create!(genre_id: 10, media_id: 27)
MediaGenre.create!(genre_id: 10, media_id: 37)
MediaGenre.create!(genre_id: 10, media_id: 41)
MediaGenre.create!(genre_id: 10, media_id: 45)

#Travel
MediaGenre.create!(genre_id: 11, media_id: 5)
MediaGenre.create!(genre_id: 11, media_id: 6)
MediaGenre.create!(genre_id: 11, media_id: 7)
MediaGenre.create!(genre_id: 11, media_id: 29)
MediaGenre.create!(genre_id: 11, media_id: 30)
MediaGenre.create!(genre_id: 11, media_id: 31)
MediaGenre.create!(genre_id: 11, media_id: 32)
MediaGenre.create!(genre_id: 11, media_id: 33)
MediaGenre.create!(genre_id: 11, media_id: 34)
MediaGenre.create!(genre_id: 11, media_id: 35)
MediaGenre.create!(genre_id: 11, media_id: 38)
MediaGenre.create!(genre_id: 11, media_id: 40)
MediaGenre.create!(genre_id: 11, media_id: 42)
MediaGenre.create!(genre_id: 11, media_id: 44)
MediaGenre.create!(genre_id: 11, media_id: 46)

#Tutorial
MediaGenre.create!(genre_id: 12, media_id: 1)
MediaGenre.create!(genre_id: 12, media_id: 3)
MediaGenre.create!(genre_id: 12, media_id: 4)
MediaGenre.create!(genre_id: 12, media_id: 6)
MediaGenre.create!(genre_id: 12, media_id: 15)
MediaGenre.create!(genre_id: 12, media_id: 17)
MediaGenre.create!(genre_id: 12, media_id: 19)
MediaGenre.create!(genre_id: 12, media_id: 20)
MediaGenre.create!(genre_id: 12, media_id: 21)
MediaGenre.create!(genre_id: 12, media_id: 22)
MediaGenre.create!(genre_id: 12, media_id: 23)
MediaGenre.create!(genre_id: 12, media_id: 24)
MediaGenre.create!(genre_id: 12, media_id: 25)
MediaGenre.create!(genre_id: 12, media_id: 26)
MediaGenre.create!(genre_id: 12, media_id: 28)
